...
The module \ty{neighbors} provides programs to support the search for
suitable neighbor genome sequences. It is centered on an \ty{sqlite3}
...
The program \ty{makeNeiDb} constructs this database from tables
supplied by the NCBI. Two types of data go into the construction
of \ty{taxonomyDb}, taxonomy information from the NCBI taxonomy
...
We can submit the taxon-IDs of interes to \ty{neighbors}, which finds
