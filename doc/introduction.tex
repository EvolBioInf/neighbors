...
Table~\ref{tab:pro}. Six of these programs are based on the taxonomy,
six on a phylogeny, and one, \ty{outliers}, on numerical data.
...
5 & \ty{fintac} & phylogeny & find target clade\\
...
climbing the phylogenetic tree.
