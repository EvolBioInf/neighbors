...
7 & \ty{makeNeiDb} & taxonomy & make neighbors database\\
8 & \ty{mrca} & phylogeny & find most recent common ancestor\\
9 & \ty{neighbors} & taxonomy & find neighbors (and targets)\\
10 & \ty{outliers} & numbers & find outliers\\
11 & \ty{pickle} & phylogeny & pick clades\\
12 & \ty{ranks} & taxonomy & distribute genomes among taxonomic ranks\\
13 & \ty{taxi} & taxonomy & get taxon-ID for taxon name\\\hline
\end{tabular}
\end{center}
\end{table}
