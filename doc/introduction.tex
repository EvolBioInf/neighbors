...
to \ty{fur}, the Neighbors package contains the program \ty{findMacs}
for finding marker candidates.

Users of programs like \ty{fur} or \ty{findMacs} need to know the
...
\ty{neighbors}, \ty{land}, \ty{pickle}, and \ty{findMacs} can be used
