...
The Neighbors package consists of the eleven programs listed in
...
8 & \ty{neighbors} & taxonomy & find neighbors (and targets)\\
9 & \ty{outliers} & numbers & find outliers\\
10 & \ty{pickle} & phylogeny & pick clades\\
11 & \ty{taxi} & taxonomy & get taxon-ID for taxon name\\\hline
\end{tabular}
\end{center}
\end{table}
...
taxa, \ty{fintac} for finding the target clade, and \ty{climt} for
