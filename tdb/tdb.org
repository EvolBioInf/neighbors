...
#+end_src
#+begin_export latex
We reslice \ty{taxa} according to the limit and the offset. The starting
point of the new taxon is the offset. The end point the starting point
plus the limit or the end of the slice, whichever is smaller. We check
that these bounds are within the slice in hand and then return the
